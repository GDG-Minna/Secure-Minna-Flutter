...
class FederalRoadSafetyTabTwoPage extends StatefulWidget {
  final SecurityAgenciesModel items;

  const FederalRoadSafetyTabTwoPage({super.key, required this.items});

  @override
  State<FederalRoadSafetyTabTwoPage> createState() =>
      _FederalRoadSafetyTabTwoPageState();
}

class _FederalRoadSafetyTabTwoPageState
    extends State<FederalRoadSafetyTabTwoPage> {
