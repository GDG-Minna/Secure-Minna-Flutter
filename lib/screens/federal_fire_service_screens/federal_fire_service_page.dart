            ...
            child: FutureBuilder(
              ...
              builder: (context, data) {
                if (data.hasError) {
                  ...
                  if (_filteredItems.isEmpty && searchController.text.isEmpty) {
                  ...
                  return _filteredItems.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return fireServiceItem(
                              title: _filteredItems[index].title.toString(),
                              subTitle:
                                  _filteredItems[index].address.toString(),
