...
class HospitalTabOnePage extends StatefulWidget {
  ...
  HospitalTabOnePage({required this.items});

  @override
  State<HospitalTabOnePage> createState() => _HospitalTabOnePageState();
}
class _HospitalTabOnePageState extends State<HospitalTabOnePage> {
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Card(
                        ...
                        child: Image(
                          fit: BoxFit.fill,
                          image: AssetImage("assets/images/hospital_header.png"),
                        ),
                      ),
                    )),
                Positioned(
