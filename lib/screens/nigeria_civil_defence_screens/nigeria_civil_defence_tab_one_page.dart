...
class NigeriaCivilDefenceTabOnePage extends StatefulWidget {
  ...
  NigeriaCivilDefenceTabOnePage({required this.items});

  @override
  State<NigeriaCivilDefenceTabOnePage> createState() => _NigeriaCivilDefenceTabOnePageState();
}
class _NigeriaCivilDefenceTabOnePageState extends State<NigeriaCivilDefenceTabOnePage> {
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Card(
                        ...
                        child: Image(
                          fit: BoxFit.fill,
                          image: AssetImage("assets/images/civil_defence_header.png"),
                        ),
                      ),
                    )),
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Image(
                        fit: BoxFit.contain,
                        image: AssetImage("assets/images/civil_defence_body.png"),
                      ),
                    )
                ),
                Positioned(
