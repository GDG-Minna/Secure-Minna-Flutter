...
class NigeriaCivilDefenceTabTwoPage extends StatefulWidget {
  ...
  NigeriaCivilDefenceTabTwoPage({required this.items});

  @override
  State<NigeriaCivilDefenceTabTwoPage> createState() => _NigeriaCivilDefenceTabTwoPageState();
}

class _NigeriaCivilDefenceTabTwoPageState extends State<NigeriaCivilDefenceTabTwoPage> {
