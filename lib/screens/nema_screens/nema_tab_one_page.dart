...
class NemaTabOnePage extends StatefulWidget {
  final SecurityAgenciesModel items;

  const NemaTabOnePage({super.key, required this.items});

  @override
  State<NemaTabOnePage> createState() => _NemaTabOnePageState();
}

class _NemaTabOnePageState extends State<NemaTabOnePage> {
                ...
                Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: Card(
                        ...
                        child: const Image(
                          fit: BoxFit.fill,
                          image: AssetImage('assets/images/nema_header.png'),
                        ),
                      ),
                    )),
                const Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: Image(
                        fit: BoxFit.contain,
                        image: AssetImage('assets/images/nema_body.png'),
                      ),
                    )),
                Positioned(
                  left: 10,
