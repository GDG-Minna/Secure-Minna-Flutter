...
class NigeriaPoliceForceTabTwoPage extends StatefulWidget {
  ...
  NigeriaPoliceForceTabTwoPage({required this.items});

  @override
  State<NigeriaPoliceForceTabTwoPage> createState() => _NigeriaPoliceForceTabTwoPageState();
}

class _NigeriaPoliceForceTabTwoPageState extends State<NigeriaPoliceForceTabTwoPage> {
