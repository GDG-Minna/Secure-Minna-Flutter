...
class NigeriaPoliceForceTabOnePage extends StatefulWidget {
  ...
  NigeriaPoliceForceTabOnePage({required this.items});

  @override
  State<NigeriaPoliceForceTabOnePage> createState() => _NigeriaPoliceForceTabOnePageState();
}
class _NigeriaPoliceForceTabOnePageState extends State<NigeriaPoliceForceTabOnePage> {
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Card(
                        ...
                        child: Image(
                          fit: BoxFit.fill,
                          image: AssetImage("assets/images/police_header.png"),
                        ),
                      ),
                    )),
                Positioned(
                    ...
                    child: Container(
                      ...
                      child: Image(
                        fit: BoxFit.contain,
                        image: AssetImage("assets/images/police_body.png"),
                      ),
                    )
                ),
                Positioned(
